...
<body>
    ...
    <div class="container-fluid" style="padding-left: 13vw; padding-top: 10vh; max-width: 100vw;">
        ...
        <div class="card" style="background-color: black;color:white; width: 65vw; margin: 0 auto; border-radius: 0.3rem; padding-top:1vh; margin-bottom: 5vh;">
            <div class="card-body">
                <h3 style="text-align: center">Edit Section 5 - Tentang</h3>
            </div>
        </div>
            ...
            <div class="card-body">
                <form method='POST' action="#" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="link1" value="{{ $section5->title }}" name="link1" required>
                    </div>
                    <div class="form-group">
                        <label for="link2">Description:</label>
                        <input type="text" class="form-control" id="link2" value="{{ $section5->description }}" name="link2" required>
                    </div>
                    <div class="form-group">
                        <label for="button">Button Text:</label>
                        <input type="text" class="form-control" id="button" value="{{ $section5->button }}" name="button" required>
                    </div>
